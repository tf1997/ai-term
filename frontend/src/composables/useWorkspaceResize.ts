...
import { loadWorkspaceWidth, persistWorkspaceWidth, type SettingsStorage } from '../lib/settingsStorage'
import { getWorkspaceWidthForKey, getWorkspaceWidthForPointer } from '../lib/workspaceLayout'
