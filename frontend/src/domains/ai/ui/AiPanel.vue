...
import { MAX_AI_COMMAND_HISTORY, formatSelectedLineRange, createMessage, formatAiError, isSensitiveAgentCommand, formatSessionDisplayTitle } from '../model/aiConversation'
import type { AiPanelProps, AiPanelEvents } from '../model/aiPanel'
import { computed, nextTick, onBeforeUnmount, onMounted, ref, watch } from 'vue'

import type { AiMessage, WorkspaceSession } from '../model/conversation'

import { chatWithAiProviderStream, onAiChatStream } from '../api'
...
import { aiStreamPartialText } from '../model/aiStreamError'
