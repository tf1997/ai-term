...
import { shellCommandForPart } from '../model/scriptPresentation'
...
import { MAX_SCRIPT_SOURCE_COMMANDS, compactCommands, inferScriptName, inferDescription, isAutoScriptName, formatError, isTauriUnavailableError, nowText } from '../model/scriptPresentation'
import { cursorPositionForTextarea, lineNumbersForScript, highlightShellScript, readinessLinesText } from '../model/scriptEditor'
import type { ScriptPanelProps, ScriptPanelEvents, ScriptChatMessage, ScriptPanelMode, ScriptLibraryView, ScriptPreviewSource, ScriptEditorSource, EditorCursor } from '../model/scriptPanel'
...
import { scriptReadinessStatusForContent } from '../model/scriptReadiness'



import { generateAiScriptTitle, saveUpdateScript } from '../api'
